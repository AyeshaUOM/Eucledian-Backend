...
namespace Etudiant.Migrations
{
    ...
    [Migration("20190809091117_AddStudentPuzzle")]
    partial class AddStudentPuzzle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Etudiant.Models.StudentPuzzles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("CollectedUserId");

                    b.Property<int>("CorrectedBy");

                    b.Property<int?>("CorrectedUserId");
                    ...
                    b.HasIndex("CollectedUserId");

                    b.HasIndex("CorrectedUserId");

                    b.HasIndex("PuzzleId");

                    b.HasIndex("StudentId");

                    b.ToTable("studentPuzzles");
                });
            ...
            modelBuilder.Entity("Etudiant.Models.StudentPuzzles", b =>
                {
                    b.HasOne("Etudiant.Models.User", "CollectedUser")
                        .WithMany()
                        .HasForeignKey("CollectedUserId");

                    b.HasOne("Etudiant.Models.User", "CorrectedUser")
                        .WithMany()
                        .HasForeignKey("CorrectedUserId");

                    b.HasOne("Etudiant.Models.Puzzle", "Puzzle")
                        .WithMany()
